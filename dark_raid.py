...
{Fore.LIGHTRED_EX}        ╔═════════════════════════╗
    ...
    #tk = f.readlines()
    id = input(f'{Fore.LIGHTRED_EX}ID do Canal onde vai ser Raidado: {Fore.LIGHTWHITE_EX}')
...
{Fore.LIGHTRED_EX}        ╔═════════════════════════╗
    ...
    id_server = input(f'{Fore.LIGHTRED_EX}ID do convite do servidor (ex 2ZRubYhv): {Fore.LIGHTWHITE_EX}')
    print('')
...
{Fore.LIGHTRED_EX}        ╔═════════════════════════╗
    ...
    id_server = input(f'{Fore.LIGHTRED_EX}ID do servidor: {Fore.LIGHTWHITE_EX}')
    print('')
